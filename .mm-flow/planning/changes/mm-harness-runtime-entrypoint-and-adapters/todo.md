...
- [ ] T2: Implement the neutral `mm` entrypoint
  - [ ] T2.1: Create the neutral CLI entrypoint and dispatch contract
  - [ ] T2.2: Wire the supported subcommands to core handlers
  - [ ] T2.3: Validate help/dispatch behavior and targeted tests
  - depends_on: T1
