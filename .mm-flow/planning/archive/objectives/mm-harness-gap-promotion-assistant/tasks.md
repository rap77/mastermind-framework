# Tasks — mm-harness-gap-promotion-assistant
...
- [ ] The package explicitly narrows phase 1 to read-only promotion preflight.
- [ ] Auto-creation remains out of scope.
...
### Acceptance Criteria
- [ ] The helper can validate a gap and emit the exact next command to materialize its objective.
- [ ] Invalid or conflicting promotion attempts fail with explicit reasons.
