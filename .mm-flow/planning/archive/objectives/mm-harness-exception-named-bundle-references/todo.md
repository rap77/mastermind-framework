# Todo — mm-harness-exception-named-bundle-references
...
- [x] T1: Define and stabilize the slice
  ...
  - depends_on: none
  - validation: Review named-bundle package for consistency.
...
- [x] T2: Implement the smallest coherent deliverable
  ...
  - depends_on: T1
  - validation: Validate bundle reference resolution.
