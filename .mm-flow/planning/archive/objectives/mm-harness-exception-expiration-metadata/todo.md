# Todo — mm-harness-exception-expiration-metadata
...
- [x] T1: Define and stabilize the slice
  ...
  - depends_on: none
  - validation: Review expiration package for consistency.
...
- [x] T2: Implement the smallest coherent deliverable
  ...
  - depends_on: T1
  - validation: Run focused tests for expiration-aware exception matching.
