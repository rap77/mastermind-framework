# Todo — mm-harness-exception-authoring-drift-reduction
...
- [x] T1: Define and stabilize the slice
  ...
  - depends_on: none
  - validation: Review authoring-drift package for consistency.
...
- [x] T2: Implement the smallest coherent deliverable
  ...
  - depends_on: T1
  - validation: Validate the chosen drift-reduction mechanism.
