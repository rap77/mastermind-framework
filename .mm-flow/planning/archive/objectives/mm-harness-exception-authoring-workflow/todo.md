# Todo — mm-harness-exception-authoring-workflow
...
- [x] T1: Define and stabilize the slice
  ...
  - depends_on: none
  - validation: Review authoring-workflow package for consistency.
...
- [x] T2: Implement the smallest coherent deliverable
  ...
  - depends_on: T1
  - validation: Validate the helper/template workflow.
