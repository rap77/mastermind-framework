# Todo — mm-harness-exception-replace-workflow
...
- [x] T1: Define and stabilize the slice
  ...
  - depends_on: none
  - validation: Review replace-workflow package for consistency.
...
- [x] T2: Implement the smallest coherent deliverable
  ...
  - depends_on: T1
  - validation: Validate the replace-by-id helper workflow.
