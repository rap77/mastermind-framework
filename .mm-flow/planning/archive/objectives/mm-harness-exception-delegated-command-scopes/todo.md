# Todo — mm-harness-exception-delegated-command-scopes
...
- [x] T1: Define and stabilize the slice
  ...
  - depends_on: none
  - validation: Review delegated-scope package for consistency.
...
- [x] T2: Implement the smallest coherent deliverable
  ...
  - depends_on: T1
  - validation: Run focused tests for exception scope handling.
