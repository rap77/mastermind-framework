# Todo — mm-harness-multi-active-exception-runtime-recognition
...
- [x] T1: Define and stabilize the slice
  ...
  - depends_on: none
  - validation: Review runtime recognition package for consistency.
...
- [x] T2: Implement the smallest coherent deliverable
  ...
  - depends_on: T1
  - validation: Run focused tests for discover and shared active-objective helpers.
...
- [x] T3: Close the continuity loop
  ...
  - depends_on: T2
  - validation: Refresh handoff and rerun contract check.
