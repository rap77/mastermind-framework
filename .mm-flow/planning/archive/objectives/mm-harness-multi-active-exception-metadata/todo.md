# Todo — mm-harness-multi-active-exception-metadata
...
- [x] T2: Implement the smallest coherent deliverable
  ...
  - depends_on: T1
  - validation: Review parser ownership, touchpoints, and operator output contract.
...
- [x] T3: Close the continuity loop
  ...
  - depends_on: T2
  - validation: Refresh handoff, record deferred sub-gaps, and rerun discovery contract check.
