# Todo — mm-harness-exception-command-bundle-metadata
...
- [x] T1: Define and stabilize the slice
  ...
  - depends_on: none
  - validation: Review command-bundle package for consistency.
...
- [x] T2: Implement the smallest coherent deliverable
  ...
  - depends_on: T1
  - validation: Run focused tests for bundle-aware exception matching.
