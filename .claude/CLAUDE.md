# AI-DLC Workflow Rules (v1.0.0)

# This file contains the AI-DLC adaptive workflow for Claude Code.
# Your project-specific rules are in the root CLAUDE.md file.
# Both files are loaded by Claude Code automatically.
