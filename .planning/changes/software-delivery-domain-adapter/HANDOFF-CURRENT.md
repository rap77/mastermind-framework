# Handoff — software-delivery-domain-adapter
...
- Use `python3 .claude/commands/mm/complete-task-handler.py --resync-objective software-delivery-domain-adapter` after repairing objective artifacts.
...
- `SDA1` from `tasks.md` — depends on adaptive-delivery-harness-runtime, harness-stage-execution-runtime, domain-security-assurance-plane.

## Validation commands for SDA1
