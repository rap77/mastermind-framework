...
## Technical Approach
- Build the smallest coherent vertical slice: stabilize the monorepo path for `rust_control_plane` and update references that depend on the current location.
...
## Validation Strategy
- Run targeted validation for any touched path/reference updates.
