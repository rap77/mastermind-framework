...
result: pass
note: Initially reported as issue (flag missing). Fixed 2026-03-20 — now appears in help: "--parallel / --no-parallel  Execute independent brains in parallel (default:"
