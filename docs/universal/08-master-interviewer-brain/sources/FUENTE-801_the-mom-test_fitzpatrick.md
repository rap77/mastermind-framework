...
**Rob Fitzpatrick** — Customer development, startup discovery, validation techniques. Experto en evitar sesgos en entrevistas con clientes y descubrir necesidades reales vs. respuestas educadas.
...
Este libro enseña cómo entrevistar clientes para descubrir necesidades reales sin sesgar sus respuestas. Su aporte principal al cerebro #8 son las reglas de "The Mom Test" para evitar opiniones educadas y descubrir comportamientos pasados reales.
...
> **P1: Never mention your idea**
> La regla más importante. Si mencionás tu idea, la gente será educada y te dirá lo que querés escuchar, no lo que realmente piensa.
> *Contexto: Aplica en toda entrevista de discovery. La primera pregunta NO debe ser sobre tu solución.*

> **P2: Talk about the past, not the future**
> La gente es mala prediciendo el futuro. En su lugar, preguntá sobre comportamientos pasados específicos.
> *Contexto: Reemplazar "¿usarías?" por "Contame sobre la última vez que..."*

> **P3: Talk less, listen more**
> Ratio 80/20: escucha 80% del tiempo, habla 20%.
> *Contexto: La gente ya está contestando sus propias preguntas mientras vos hablás.*

> **P4: The Three Lies**
> 1. "I'd definitely buy that" — Nadie paga nada hasta que existe
...
> *Contexto: Estas frases son señales de alerta, no validación.*

### 2. Frameworks y Metodologías

#### FM1: The Mom Test Framework
...
4. **Conduct interview** — Escucha más de lo que hablás
5. **Look for patterns** — 3-5 conversaciones similares = patrón

**Cuándo usar:** En toda entrevista de descubrimiento con clientes o usuarios.

#### FM2: Good vs Bad Questions

| ❌ Mal (Future, Hypothetical) | ✅ Bien (Past, Specific) |
|------------------------------|-------------------------|
| "Would you use a app that does X?" | "Tell me about the last time you did X." |
| "How much would you pay for this?" | "How much do you currently spend to solve X?" |
| "Would this feature be useful?" | "When was the last time X was a problem?" |

### 3. Modelos Mentales

#### MM1: The Compliment Sandwich
...
#### CD1: Cuándo Creer una Respuesta
