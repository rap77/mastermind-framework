...
BrainConfig = Annotated[
    Union[VectorSearchBrain, GenerativeBrain], Field(discriminator="type")
]
...
class ConfigFile(BaseModel):
    ...
    brains: list[BrainConfig] = Field(
        default_factory=list, description="List of brain configurations"
    )
