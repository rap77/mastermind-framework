...
"""
    ...
    def create_brain_7_query(self, output: dict[str, Any], brain_id: int = 1) -> str:
...
"""
    ...
    def get_brain_status(self) -> dict[str, dict[str, str]]:
        """Get status of all brain notebooks."""
        return {
            str(brain_id): {"notebook_id": notebook_id, "status": "active"}
