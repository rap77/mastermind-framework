"""SQLAlchemy session management for project state."""
...
def initialize_database(database_url: str) -> None:
    """Create all project state tables for the given database URL."""
    from mastermind_cli.project_state import models as _models  # noqa: F401
