...
# These will fail initially until we implement the module
...
def whatsapp_message():
    ...
    return {"to": "1234567890", "message_type": "text", "text": "Hello, world!"}
...
class TestWhatsAppSender:
    ...
    async def test_send_media_message_success(
        ...
        from routers.whatsapp import send_whatsapp_media
