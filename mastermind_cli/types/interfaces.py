...
class Brief(BaseModel):
    ...
    problem_statement: str = Field(
        ...,
        min_length=10,
        description="Clear description of the problem or request"
    )
    context: str = Field(
        "",
    ...
    target_audience: Optional[str] = Field(
        None,
        description="Who is this for? (optional)"
    )
...
class BrainInput(BaseModel):
    ...
    additional_context: dict = Field(
        ...
        description="Any additional data from previous brains"
    )
...
class ProductStrategy(BaseModel):
    ...
    key_features: list[str] = Field(
        ...,
        min_length=1,
        description="Core features of the product"
    )
    ...
    generated_at: datetime = Field(
        ...
        description="When this strategy was generated"
    )
...
class UXResearch(BaseModel):
    ...
    pain_points: list[str] = Field(
        ...,
        min_length=1,
        description="User problems to solve"
    )
    ...
    generated_at: datetime = Field(
        default_factory=datetime.now,
        description="When this research was generated"
    )
...
class UIDesign(BaseModel):
    ...
    component_hierarchy: list[dict] = Field(
        ...,
        min_length=1,
    ...
    generated_at: datetime = Field(
        default_factory=datetime.now,
        description="When this design was generated"
    )
...
class FrontendDesign(BaseModel):
    ...
    component_hierarchy: dict = Field(
        ...,
    ...
    build_tools: list[str] = Field(
        default_factory=list,
        description="Required build tools"
    )
    generated_at: datetime = Field(
        default_factory=datetime.now,
        description="When this design was generated"
...
class GrowthDataEvaluation(BaseModel):
    ...
    rejection_reasons: list[str] = Field(
        default_factory=list,
        description="Reasons for rejection (if REJECT)"
    )
    evaluated_at: datetime = Field(
        default_factory=datetime.now,
        description="When this evaluation was made"
    )
...
class MasterInterviewerOutput(BaseModel):
    ...
    interview_plan: list[dict] = Field(
        ...,
        description="Questions to ask user"
    )
    clarified_brief: Optional[Brief] = Field(
        None,
        description="Clarified brief after interview"
    )
...
class BrandStrategy(BaseModel):
    ...
    visual_guidelines: dict = Field(..., description="Visual guidelines")
    generated_at: datetime = Field(default_factory=datetime.now)
